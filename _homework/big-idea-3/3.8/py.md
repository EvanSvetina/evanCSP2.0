...
toc: False
comments: False
permalink: /homework/big-idea-3/3.8/py
comments: true
---
...
```python
for i in range(1,11): #cheeky bastards doing index nerd stuff GRAAAHGFRTGHEYU
  print(i)
```
...
```python
fruits = ["pomegranate", "cupuasu", "strawberries", "raspberries"] #im in genuine disbelief that yall misspeled favorite BOTH TIMES :sob:
